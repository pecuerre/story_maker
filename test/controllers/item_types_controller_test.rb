...
class ItemTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should get index" do
    get universe_item_types_url(universe_slug: @universe.slug)
  ...
  test "should create item type as json" do
    assert_difference("ItemType.count") do
      post universe_item_types_url(universe_slug: @universe.slug),
  ...
  test "should update item type as json" do
    patch universe_item_type_url(universe_slug: @universe.slug, id: @item_type),
