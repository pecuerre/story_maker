...
s_b1 = Section.create(universe: universe, name: "The Fellowship of the Ring", section_tags: [ st_book ], parent: nil)
s_b2 = Section.create(universe: universe, name: "The Two Towers", section_tags: [ st_book ], parent: nil)
s_b3 = Section.create(universe: universe, name: "The Return of the King", section_tags: [ st_book ], parent: nil)